...
import (
	...
	logsv1 "github.com/argus-labs/go-ecs/internal/app/world-cli/gen/logs_service/v1"
	"github.com/argus-labs/go-ecs/internal/app/world-cli/gen/logs_service/v1/logs_servicev1connect"
...
func (h *Handler) createLogsClient(params *logParams) (
	logs_servicev1connect.LogsServiceClient,
	*connect.Request[logsv1.GetLogsRequest],
) {
	client := logs_servicev1connect.NewLogsServiceClient(
		http.DefaultClient,
...
func streamLogs(ctx context.Context,
	client logs_servicev1connect.LogsServiceClient,
