...
package logs_servicev1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1 "github.com/argus-labs/go-ecs/internal/app/world-cli/gen/logs_service/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	LogsServiceName = "logs_service.v1.LogsService"
)
...
const (
	...
	LogsServiceGetLogsProcedure = "/logs_service.v1.LogsService/GetLogs"
)

// LogsServiceClient is a client for the logs_service.v1.LogsService service.
type LogsServiceClient interface {
	GetLogs(context.Context, *connect.Request[v1.GetLogsRequest]) (*connect.ServerStreamForClient[v1.GetLogsResponse], error)
}

// NewLogsServiceClient constructs a client for the logs_service.v1.LogsService service. By default,
...
func NewLogsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) LogsServiceClient {
	...
	logsServiceMethods := v1.File_logs_service_v1_logs_proto.Services().ByName("LogsService").Methods()
...
// GetLogs calls logs_service.v1.LogsService.GetLogs.
...
// LogsServiceHandler is an implementation of the logs_service.v1.LogsService service.
...
func NewLogsServiceHandler(svc LogsServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/logs_service.v1.LogsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedLogsServiceHandler) GetLogs(context.Context, *connect.Request[v1.GetLogsRequest], *connect.ServerStream[v1.GetLogsResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("logs_service.v1.LogsService.GetLogs is not implemented"))
}
